...
var news = mp.blips["new"](498, new mp.Vector3(-1070, -246, 53), {
  name: 'Новостное агенство',
  color: 1,
  shortRange: true,
  scale: 0.9
});
var tuning = mp.blips["new"](72, new mp.Vector3(-351, -134, 29), {
  name: 'Тюнинг сервис',
  color: 4,
  shortRange: true,
  scale: 0.9
});
var autosaloon_medium = mp.blips["new"](225, new mp.Vector3(-75.39668273925781, 64.27561950683594, 57.21598434448242), {
  name: 'Автосалон среднего класса',
  color: 57,
  shortRange: true,
  scale: 0.9
});
var airport = mp.blips["new"](90, new mp.Vector3(-1032.6295166015625, -2732.058837890625, 63.038902282714844), {
  name: 'Аеропорт ',
  color: 0,
  shortRange: true,
  scale: 0.9
});
var coliseum = mp.blips["new"](24, new mp.Vector3(-319.33905029296875, -1974.3548583984375, 87.76261901855469), {
  name: 'Колизей ',
  color: 0,
  shortRange: true,
  scale: 0.9
...
var driving_school = mp.blips["new"](545, new mp.Vector3(-634.9441528320312, -2259.55224609375, 5.932521343231201), {
  name: 'Автошкола',
  color: 38,
  shortRange: true,
  scale: 0.9
});
var fraction_FIB = mp.blips["new"](188, new mp.Vector3(2479.0087890625, -391.23455810546875, 109.50233459472656), {
  name: 'FIB',
  color: 58,
  shortRange: true,
  scale: 0.9
});
var fraction_EMS = mp.blips["new"](61, new mp.Vector3(303.479248046875, -586.5426025390625, 57.70624542236328), {
  name: 'EMS',
  color: 59,
  shortRange: true,
  scale: 0.9
});
var fraction_LSPD = mp.blips["new"](60, new mp.Vector3(436.385009765625, -984.70947265625, 43.66206741333008), {
  name: 'LSPD',
  color: 57,
  shortRange: true,
  scale: 0.9
...
mp.peds["new"](mp.game.joaat('csb_imran'), new mp.Vector3(-57.100257873535156, -1098.99658203125, 26.422422409057617), 4.079876899719238); // Автосалон PDE