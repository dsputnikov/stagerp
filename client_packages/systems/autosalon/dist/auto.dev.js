...
var enterAuto = mp.colshapes.newSphere(-803.830810546875, -224.1153564453125, 37.22683334350586, 1);
var exitAuto = mp.colshapes.newSphere(-801.3224487304688, -222.78689575195312, 37.07965850830078, 1);
var enterAutosred = mp.colshapes.newSphere(-44.13488006591797, -1660.9564208984375, 29.28295135498047, 1);
var exitAutosred = mp.colshapes.newSphere(-41.82459259033203, -1663.365966796875, 29.4867000579834, 1); //
...
mp.events.add("AutoLuxeIn::CLIENT", function () {
...
mp.events.add("AutoLuxeOut::CLIENT", function () {
...
function autoShowWindowExit() {
  ...
  global.browser.execute("Autounshow.open = true"); //browser.execute("Autounshow.modal.active = false");
