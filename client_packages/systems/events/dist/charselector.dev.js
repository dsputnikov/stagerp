...
mp.events.add('Charselector_showSelector::CLIENT', function (data) {
  global.browser.call('Charselector_showSelector::CEF', true, data);
  global.browser.execute("CharSelector.load('".concat(data, "')"));
  global.browser.execute("CharSelector.active = true");
  mp.gui.cursor.show(false, false);
});
mp.events.add('Charselector_selectCharacter::CLIENT', function (data) {
