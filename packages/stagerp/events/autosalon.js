...
var salons = [
    {
        ...
        vehicles: [
            ...
            { name: 'ВАЗ 2107', price: 5000, model: 'lada2107' },
            { name: 'Лада Нива', price: 9000, model: 'urban' },
        ],
    ...
    },
    {
        ...
        blipColor: 83,
        vehicles: [
            { name: 'Buggati Chiron', price: 330000, model: 'bug300ss' },
            { name: 'Rolls-Royce Wraith', price: 250000, model: 'wraith' },
            { name: 'Rolls-Royce Cullinan', price: 270000, model: 'rculi' },
            { name: 'BMW X5M', price: 240000, model: 'x5m' },
            { name: 'BMW M4 F82', price: 200000, model: 'm4f82' },
            { name: 'BMW M5 F90', price: 230000, model: 'm5f90' },
            { name: 'Mercedes AVTR', price: 400000, model: 'avtr' },
            { name: 'Mercedes Benz S-class', price: 170000, model: 's500w223' },
            { name: 'Porsche 911 GT3 RS', price: 270000, model: 'pgt3rs19' },
            { name: 'Porsche Panamera 17 Turbo', price: 230000, model: 'panamera17turbo' },
            { name: 'Mercedez Benz AMG GT', price: 220000, model: 'mbbs20' },
            { name: 'Audi RS7', price: 170000, model: 'rs721' },
            { name: 'Ford Mustang GT', price: 210000, model: 'fmgt18' },
        ],
